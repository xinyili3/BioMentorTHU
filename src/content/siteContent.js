...
const en = {
  ...
  support: {
    heading: { eyebrow: 'What We Support', title: 'From early questions to final application materials.' },
    items: [
      { title: 'PhD Journey & Planning', description: 'Explore whether PhD training fits your goals, how your research interests may evolve, and what kinds of programs and research environments are the right fit.', details: ['PhD planning', 'Research direction', 'School / program selection', 'General PhD life and research career questions'] },
      { title: 'Application Support', description: 'Receive focused feedback on specific parts of your graduate school application from mentors with relevant experience and availability.', details: ['CV review', 'Statement of purpose review', 'Personal statement review', 'Interview preparation'] },
    ],
  },
  pilot: {
    heading: { eyebrow: '2026 Pilot Cohort', title: 'Starting small. Building thoughtfully.', description: 'For the inaugural 2026 cohort, the program will primarily support Tsinghua students applying to graduate programs during the current application cycle.' },
  ...
  process: {
    heading: { eyebrow: 'How It Works', title: 'A simple process designed around fit, flexibility, and care.' },
    steps: [
      { number: '01', title: 'Apply', description: 'Tell us about your research interests, application plans, mentoring needs, and availability.' },
      { number: '02', title: 'Match', description: 'We match mentees and mentors based primarily on research interest, mentoring need, and availability, while also considering preferences whenever possible.' },
      { number: '03', title: 'Connect', description: 'Meet online for individualized conversations and feedback. Different parts of an application may be supported by different mentors depending on expertise.' },
      { number: '04', title: 'Grow', description: 'Use mentor feedback to refine your thinking, strengthen your application, and make more informed decisions about your next stage of training.' },
    ],
  },
  mentorCall: {
    heading: { eyebrow: 'For Mentors', title: 'Help mentees navigate the path ahead.', description: 'We welcome current PhD students, recent PhD graduates, and postdoctoral researchers with a Tsinghua background in the life, biomedical, and related sciences. Mentoring is entirely volunteer-based and designed to be flexible.' },
...
const zh = {
  ...
  support: {
    heading: { eyebrow: '我们提供的支持', title: '从最初的困惑，到完整的申请材料。' },
    items: [
      { title: '博士道路与规划', description: '探索博士训练是否符合你的目标、研究兴趣可能如何发展，以及怎样的项目与科研环境更适合你。', details: ['博士阶段规划', '研究方向探索', '学校与项目选择', '博士生活与科研职业相关问题'] },
      { title: '申请支持', description: '由具有相关经验且时间合适的导师，针对研究生申请的具体环节提供有重点的反馈。', details: ['简历修改建议', '学术目的陈述修改建议', '个人陈述修改建议', '面试准备'] },
    ],
  },
  pilot: {
    heading: { eyebrow: '2026 首期试点', title: '从小规模起步，用心把它做好。', description: '首期 2026 项目将主要支持正在本申请季申请研究生项目的清华学生。' },
  ...
  process: {
    heading: { eyebrow: '参与流程', title: '围绕匹配度、灵活性与关怀设计的简单流程。' },
    steps: [
      { number: '01', title: '提交申请', description: '向我们介绍你的研究兴趣、申请计划、希望获得的指导以及时间安排。' },
      { number: '02', title: '导师匹配', description: '我们主要根据研究兴趣、指导需求与双方时间进行匹配，并在条件允许时兼顾个人偏好。' },
      { number: '03', title: '建立联系', description: '通过线上交流获得个性化讨论与反馈。根据导师专长，申请材料的不同部分可能由不同导师提供支持。' },
      { number: '04', title: '持续成长', description: '运用导师反馈梳理思路、完善申请，并为下一阶段的科研训练做出更充分的决定。' },
    ],
  },
  mentorCall: {
    heading: { eyebrow: '致导师', title: '帮助学生更从容地走好前方的路。', description: '我们欢迎具有清华背景、来自生命科学、生物医学及相关领域的在读博士生、近期博士毕业生和博士后研究人员加入。导师工作完全基于志愿参与，并可灵活安排。' },
